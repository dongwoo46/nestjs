...
describe('BookService', () => {
  let bookService: BookService; // bookServie 정의
  let model: Model<Book>; // model 정의
  ...
  beforeEach(async () => {
    // testing module로 book.service.ts 가져오기
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        BookService,
        {
          // mongoose로 엔티티 토큰 가져오기
    ...
    // 위에서 컴파일한 book.service.ts 모듈에서 변수에 삽입
